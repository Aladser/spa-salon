...
<body>
    <section class='loginSection'><form method="POST" action='../php_scriptes/auth.php'>
        ...
        <div class='form-row'>
            ...
            <input type='text' class='login-input' name='login' id='login-input' autocomplete='on' value='admin'>
            <?php
        ...
        <div class='form-row'>
            ...
            <input type="password" class='password-input' name='password' id='password-input' autocomplete="on" value='admin'>
        </div>
